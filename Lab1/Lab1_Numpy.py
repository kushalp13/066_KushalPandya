...
aList = [1, 2, 3, 4, 5] #python list
npArray = np.array(aList) #numpy array
...
#algebric operation on list vs numpy array
print(aList + aList)
print(npArray + npArray)
print(aList * 3)
print(npArray * 3)

#matrix from array and list
...
gMatrix = np.array([[1, 2], [3, 4]])
bMatrix = np.array([[1, 2], [1, 2, 3]], dtype=object)
...
result1 = gMatrix * 2 + 1
print(result1)
result1 = gMatrix + gMatrix
print(result1)
result2 = gMatrix - gMatrix
print(result2)
result1 = gMatrix * gMatrix
print(result1)
